    ...
    <div class="col 12">
        ...
        <div class="alert alert-success" role="alert">
            ...
            <p class="mb-0">Untuk langkah selanjutnya silahkan update data diri anda pada link berikut, <a
                    href="/dashboard18/edit-data18"><b>Update Data</b></a>.</p>
        </div>
        @else
        <div class="col-md-6">
            ...
            <div class="card card-primary card-outline">
                <div class="card-body box-profile">
                    <div class="text-center">
                        ...
                        <form action="/dashboard18/update-foto-profil18" method="POST" class="form-horizontal"
                    ...
                    <ul class="list-group list-group-unbordered mb-3">
                        ...
                        <li class="list-group-item">
                            <a href="/dashboard18/ganti-password18" class="btn btn-danger float-left"><i
                                    class="fa fa-tools"></i> Ganti password</a>
                            <a href="/dashboard18/edit-data18" class="btn btn-info float-right"><i
