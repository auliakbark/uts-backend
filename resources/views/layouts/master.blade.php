        ...
        <div class="wrapper">
            ...
            <aside class="main-sidebar sidebar-dark-primary elevation-4">
               ...
               with font-awesome or any other icon font library -->
                            <li class="nav-item @php if(\Request::path() == 'admin18/dashboard18')echo " menu-open"
                                @endphp">
                                <a href="/admin18/dashboard18" class="nav-link">
                            ...
                            <li class="nav-item @php if(\Request::path() == 'admin18/data-agama18')echo " menu-open"
                                @endphp">
                                <a href="/admin18/data-agama18" class="nav-link">
                            ...
                            <li class="nav-item">
                                <a href="/logout18" class="nav-link">
            ...
            <footer class="main-footer">
                <div class="float-right d-none d-sm-inline-block">
                    &copy; V3421018 <b>- A - </b><b>Aulia Akbar Khoiruddin</b>
                </div>
            </footer>
        </div>
        <!-- ./wrapper -->
