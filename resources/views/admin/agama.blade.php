                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="/admin18/data-agama18/edit18/{{$item->id}}" class="text-success mx-2"><i
                                        class="fa fa-edit fa-lg"></i></a>
                                <a href="/admin18/data-agama18/delete18/{{$item->id}}" class="text-danger mx-2"><i
        ...
        <div class="modal fade" id="tambah-agama">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="/admin18/data-agama18/create18" method="POST">
                        @csrf
