    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body row">
                ...
                <div class="col-md-4">
                    <form action="/admin18/dashboard18/update-foto-profil18" method="POST" class="form-horizontal"
                ...
                <table id="table" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href={{"/admin18/dashboard18/detail18/".Crypt::encrypt($item->id)}} class="btn
                                    btn-primary mx-1"><i class="fa fa-info-circle"></i> Detail</a>
                                @if ($item->is_aktif=='0')
                                <a href={{"/admin18/approve18/".Crypt::encrypt($item->id)}} class="btn btn-success
